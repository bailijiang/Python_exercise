...
def update_bullets(ai_settings, screen, sb, stats, ship, aliens, bullets):
    ...
    check_bullet_alien_collisions(ai_settings, aliens, stats, sb, bullets, screen, ship)


def check_bullet_alien_collisions(ai_settings, aliens, stats, sb, bullets, screen, ship):
